<template>
  <div class="his-box">
    ...
    >
      <div class="drawer2"><span style="color: red; font-family: Microsoft JhengHei UI, sans-serif;">功能筛选</span></div>
      <div class="drawer3">
    ...
    >
      ...
      >
        <el-menu-item-group>
          ...
          >
          <el-menu-item index="3" @click="onlyObtainTargets"
            ><h3><i class="iconfont icon-tiqu"></i>目标提取</h3></el-menu-item
          >
          <el-menu-item index="4" @click="onlyClassify"
            ><h3>
              <i
