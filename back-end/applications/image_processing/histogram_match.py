...
from applications.common.path_global import md5_name, generate_dir, generate_url


def gram_match(names, data_dir, save_dir,flag=True):  # DATA_DIR为第一时期图文件夹，Matched_dir为匹配的图片文件夹(第二时期)，save_dir为将储存结果放置的文件夹名称
